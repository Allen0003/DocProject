...
public class DocCtlDao {
    ...
    public ArrayList<DocCtl> getAllDocCtl() throws SQLException {
        PreparedStatement pstmt = conn
                .prepareStatement("Select * from DocCtl order by DocType, Sysdt DESC");
    ...
    public ArrayList<DocCtl> getDocCtlByType(String type) throws SQLException {
        ...
        PreparedStatement pstmt = conn
                .prepareStatement("Select * from DocCtl Where DocType = ? order by Sysdt DESC");
        pstmt.setString(1, type);
        return getDocCtls(pstmt);
    }

    public ArrayList<DocCtl> getDocCtlByType(String type, String uid)
            throws SQLException {

        PreparedStatement pstmt = conn
                .prepareStatement("Select * from DocCtl"
                        + " left join   UserAuth  on DocCtl.DocID = UserAuth.DocID"
    ...
    private ArrayList<DocCtl> getDocCtls(PreparedStatement pstmt)
            throws SQLException {
    ...
    public void addDocCtl(DocCtl docCtl) throws SQLException {
        ...
        PreparedStatement pstmt = conn
                .prepareStatement("insert into DocCtl  (DocID,DocName,DocType,memo ,Sysid ,Sysdt )"
                        + " values (?,?,?,?,?,?)");
    ...
    public void addDocCtlHis(String docID, String userID, String batchNum)
            throws SQLException {
    ...
    private void setValues(PreparedStatement preparedStatement, String[] values)
            throws SQLException {
