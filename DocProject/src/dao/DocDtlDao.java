...
public class DocDtlDao {
    ...
    // get 一群 DocDtl
    private ArrayList<DocDtl> getDocDtls(PreparedStatement pstmt)
            throws SQLException {
    ...
    public ArrayList<DocDtl> getDocDtl(String docID) throws SQLException {
        ...
        // .prepareStatement("Select * From  DocDtl  where DocID = ?   order by  [FileName]desc  ,Sysdt desc");
        // pstmt.setString(1, docID);
        return getDocDtl(docID, Const.DocID_For_all);
    }

    // 用在印query/dtl 的畫面上
    public ArrayList<DocDtl> getDocDtl(String docID, int hisZone)
            throws SQLException {
        String sql = "";
    ...
    public void addDocDtlHis(String docID, String userID, String batchNum,
            String docSN) throws SQLException {
        // 先把要刪掉的資訊存取起來
